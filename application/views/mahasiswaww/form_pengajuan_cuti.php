            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form action="<?= base_url();?>Form_Cuti/proses_cuti" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="berakhir">Tempat Lahir</label>
                            <input type="text" class="form-control" id="tmpt_lahir" aria-describedby="tmpt_lahir"
                                name="tmpt_lahir" required>
                        </div>
                        <div class="form-group">
                            <label for="berakhir">Alamat</label>
